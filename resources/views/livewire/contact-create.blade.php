    ...
    <div class="flex flex-wrap -mx-3 mb-6">
        <form class="flex flex-wrap w-full" wire:submit.prevent="store">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input wire:model="phone" class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('phone') border-red-500 @enderror rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-300" id="grid-last-name" type="text" placeholder="+628126498">
                @error('phone')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
